...
$not_valid_ids = array("ui_codex_unlockTotal");
$fixations = array(
...
$m_society = array(
	"cats" => array("craft", "specifics", "rod", "society", "pani", "opati"),
	"text" => "ui_tab_society"
);
$m_character = array(
...
"spoilerModalText" => "Nous savons que beaucoup de gens s'inquiètent des spoilers. L'ouverture de ce lien <b>pourrait vous montrer où se trouvent certaines choses que vous préférez peut-être découvrir</b> pendant le jeu. Ce message est seulement montré pour certains endroits, ne pas tenir compte des premières étapes du jeu. Alors:",
	...
	"cs" => array(
		...
		"name" => "ČEŠTINA",
		"search" => "Hledat ...",
		"welcome" => "Vítejte v on-line {$kcdName} čtenáři kodex. Vyrobeno pomocí jazykových a obrazových souborů z hry s láskou {$nachazoUrl}.",
		"issues" => "V projektu {$issuesLink} můžete odeslat zpětnou vazbu a problémy.",
		"change" => "Jazyk můžete změnit kliknutím na požadovaný příznak v seznamu.",
		"lang" => "Zvolený jazyk je:",
		"viewSection" => "Zobrazit sekci",
		"viewMenu" => "Otevřít/zavřít nabídku",
		"mapOnline" => "Mapovat online",
		"cookiesAdvise" => "Tyto stránky používají soubory cookie pro uložení článku v posledním článku, jazyk a pokud označujete jako přečtené články. Chcete-li to odstranit z vašeho prohlížeče, odstraňte všechny uložené soubory cookie <code>kcd_codex_*</code>.",
	...
	"pl" => array(
		...
		"name" => "POLSKIE",
		"search" => "Wyszukaj...",
		"welcome" => "Witamy w internetowym programie {$kcdName} czytelnik codexu. Wykonane przy użyciu plików z językiem i obrazami z gry z miłością {$nachazoUrl}.",
		"issues" => "Możesz przesłać opinię i problemy w {$issuesLink} projekcie.",
		"change" => "Możesz zmienić język klikając na wybraną flagę na liście.",
		"lang" => "Wybrany język to:",
		"viewSection" => "Wyświetl sekcję",
		"viewMenu" => "Otwórz/zamknij menu",
		"mapOnline" => "Mapuj online",
		...
		"spoilerModalTitle" => 'Może zobaczyć spoilery...',
		...
		"spoilerModalYesAlways" => 'Tak! Otwórz to tym razem i zawsze',
		"spoilerModalYesThis" => 'Tak! Otwórz tylko tym razem...',
		"spoilerModalNoNever" => 'Nie! Wolę się odkrywać',
	),
	"tk" => array(
